...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChild(ImGuiID m_Id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          BeginChildFrame(ImGuiID m_Id, const ImVec2& size, ImGuiWindowFlags flags = 0); // helper to create a child window / scrolling region that looks like a normal widget frame
